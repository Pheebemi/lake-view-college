...
# Email Settings
# Falls back to printing emails to the console when no SMTP user is
# configured, so local dev never needs real cPanel credentials.
_email_configured = bool(os.getenv('EMAIL_HOST_USER'))
EMAIL_BACKEND = os.getenv(
    'EMAIL_BACKEND',
    'django.core.mail.backends.smtp.EmailBackend' if _email_configured else 'django.core.mail.backends.console.EmailBackend'
)
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@lakeviewcoe.edu.ng')

# Password reset links expire after 24 hours (matches the wording in the reset email)
